...
# Parsing + Configuration Script – MONMNSMQT001.0BATTS - Rev. A

This **Parsing + Configuration** script is designed for the **MONMNSMQT001.0BATTS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MONMNSMQT001.0BATTS Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MONMNSMQT001.0BATTS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
